...
int main()
{
    ...
    printf("Lunar Lander - (c) 2012, by <lyh>\n");
    while(altitude > 0 )
    {
        if(fuel>0){
            printf("Altitude: %.2f\n", altitude);
     ...
     if(fuel == 0) printf("You have 0 kilograms of fuel and you are falling...\n");
    ...
    if(fabs(velocity) > 3)
    {
        ...
        printf("Congratulation! Your are landing successfully and safely!");
        printf("Your remaining fuel is %lf, all time is :%d seconds", fuel, i);
    }
}
